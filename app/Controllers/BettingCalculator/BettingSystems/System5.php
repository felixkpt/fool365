...
class System5 extends Settings {

    use CommonTraits;

    public $system = 5;
    public $title = "Win just one parlay in a ten bet series";
    public $description = "<p>This is a betting system that constantly have shown a steady profit for
me.
</p>
<p>
The goal of the system is to win just one parlay in an ten bet series.
This is only a 10% winning rate. So, if you can pick a winner within 10
picks (or more if you have a bigger bankroll or you use underdogs),
you make a profit.
</p>
<p>
...
sportsbooks are making their money.</p>";
    public $min_odds = '1.70';
    public $max_odds = '2.20';
